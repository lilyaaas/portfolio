...
const LanguageSwitcher = () => {
  ...
  return (
    <div className="relative inline-block">
      <button
        className="group relative flex items-center justify-center w-10 h-10 text-white/30 transition-all duration-300 rounded-full hover:text-primary hover:bg-white/4 hover:scale-105 focus:outline-none active:scale-95 cursor-pointer"
